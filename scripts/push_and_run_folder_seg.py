...
"""
python scripts/push_and_run_folder_seg.py --exp=1 --time=4 --gpus=1 --mem=10240 --workers=32 --ram=60 --scratch=300 --fake=True
"""
...
for j,e in enumerate(exps):
  ...
  if not ign and doc['train_dataset']['loader']['num_workers'] != w:
...
if len(model_paths) == 0:
  ...
  try:
    ...
    for j, e in enumerate(exps):
      e = e.replace('/home/jonfrey/RPOSE/','')
      ...
      cmd += f"""/cluster/home/jonfrey/miniconda3/envs/track4/bin/python segmentation/main_segmentation.py --exp={e}"""  
      cmd = cmd.replace('\n', '')
      t = ""
      # python_gpu/3.8.5 
